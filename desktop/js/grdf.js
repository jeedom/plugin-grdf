...
function printEqLogic(_eqLogic) {
	document.querySelectorAll('.hide-' + _eqLogic.configuration.measure_type).forEach(_toHide => {
		_toHide.style.display = 'none'
	}) // 4.4 mini => document.querySelectorAll('.hide-' + _eqLogic.configuration.measure_type).unseen()
	document.querySelectorAll('.show-' + _eqLogic.configuration.reading_frequency).forEach(_toShow => {
